        ...
        <div className='max-w-[1240px] m-auto md:grid grid-cols-2 gap-2'>
          <div className='col-span-2 grid justify-center align-middle mt-16'>
            ...
            <div className='max-w-[800] bg-gray-50/25 p-4 mt-4'>
              ...
              <p className='py-2 text-lg font-semibold'>With a residency at Portland's top EDM club 45 East, Matsu.MOTO has become a rising DJ in the Portland area. Opening for a wide range of artists like Keys n Krate, S!ckick, Madeon, Capozzi, Nitti Gritti, Boombox Cartel, SNBRN, Dillon Francis, and DJ Pauly D., He showcases versatility and ability to cater to different crowds.</p>

              <p className='py-2 text-lg font-semibold'>Matsu.MOTO sets are characterized by infectious beats, booty shaking bass, and a keen eye for what the crowd want. Whether playing for thousands at a club or a for a smaller crowd in more intimate venues, Matsu.MOTO never fails to keep the energy high and the dance floor moving.</p>
