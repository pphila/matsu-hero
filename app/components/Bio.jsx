...
const Bio = () => {
  return (
    <>
      <div className='bg-gray-50 text-gray-950 w-full md:h-screen p-2 py-16'>
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
          ...
          <div className='w-full h-auto m-auto shadow-2xl col-span-2 shadow-gray-400 flex items-center justify-center hover:scale-110 ease-in duration-200'>
