...
// import bgImg from './../public/assets/img/matsu-bg.jpg';
  ...
  return (
    <>
      ...
      <main>
        ...
        <div className='flex items-center justify-center fixed bg-cover bg-center bg-no-repeat w-full h-screen custom-image z-[-1]'>
